...
export const run: RunFunction = async (client, message) => {
    ...
    try {
        ...
        const embed = client.embed(
            {
                ...
                footer: { text: `Página 1 de ${servers.length}` },
            },
            message
        );
        ...
        backwards.on('collect', (r, u) => {
            ...
            embed.setFooter(`Página ${page} de ${servers.length}`);
            msg.edit(embed);
        ...
        forwards.on('collect', (r, u) => {
            ...
            embed.setTitle(servers[page - 1].attributes.name);
            embed.fields = makeFields(page - 1, servers) as EmbedField[];
            embed.setFooter(`Página ${page} def ${servers.length}`);
            msg.edit(embed);
            r.users.remove(r.users.cache.find((u) => u === message.author));
        });
    } catch (e) {
...
export const help = {
    ...
    description: 'Ver informação de todos servidores',
    usage: 'servers',
};
